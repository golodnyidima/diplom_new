        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="http://diplom.dev/">Главная <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://diplom.dev/news">Новости</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link disabled" href="http://diplom.dev/composition">Состав кафедры</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://diplom.dev/contacts">Контакты</a>
                </li>
            </ul>
